...
const SMicons = ({sx,color}:{color?:string,sx?:any}) => {
  return (
    ...
    <Box className='flex white' sx={{fill:'white',mt:1}}>
         ...
         <a href=' https://www.facebook.com/CivilEnGuide' style={{color:'#3d8af7',fill:'#3d8af7'}} className='white' target='_blank' rel='noopener' >
         ...
         <a href='https://www.instagram.com/civilenguide/' style={{color:'#3d8af7',fill:'#3d8af7'}} className='white' target='_blank' rel='noopener' >
              <CiInstagram></CiInstagram>
         </a>
        
            </Box>
            <Box fontSize='2em' className='cursor pointer' sx={{width:'50px'}}>
         <a href='https://www.linkedin.com/in/civil-enguide-974799202/' style={{color:'#3d8af7',fill:'#3d8af7'}} className='white' target='_blank' rel='noopener' >
